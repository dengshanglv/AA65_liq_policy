...
ncond1 = sidx(solve(noweq(7), cond(1)), 1);
ncond2 = sidx(solve(noweq(8), cond(2)), 1);
[zconc1, zconc2, zcond1, zcond2] = solve(noweq([5,6,9,10]), [conc,cond]);

noweq(3) = nconc1 - conc(1);
noweq(4) = nconc2 - conc(2);
noweq(7) = ncond1 - cond(1);
noweq(8) = ncond2 - cond(2);

noweq(5) = zconc1 - conc(1);
noweq(6) = zconc2 - conc(2);
noweq(9) = zcond1 - cond(1);
noweq(10) = zcond2 - cond(2);

[sconc1,sconc2,scond1,scond2,sq1,sq2,syc1,syc2,syd1,syd2,smc1,smc2,smd1,smd2] = ...
    vpasolve(noweq,[conc, cond, q, yc, yd, mc, md], [2.4198    2.4198    1.2691    1.5532    0.6556    0.5135    0.1367    0.1367    0.1367    0.1367    0.3863    0.3863    0.2026    0.2480]);
